...
--- @return void
function OpenURLByType *private* (urlType) end

--- @param urlType [ApprovedURLType|#ApprovedURLType]
--- @return urlText string
function GetURLTextByType *private* (urlType) end

--- @param urlType [ApprovedURLType|#ApprovedURLType]
--- @return urlOpensInOverlay bool
function ShouldOpenURLTypeInOverlay *private* (urlType) end

--- @param chapterId integer
--- @param isCollectorsEdition bool
--- @param source [ChapterUpgradeSource|#ChapterUpgradeSource]
--- @return void
function OpenChapterUpgradeURL *private* (chapterId,isCollectorsEdition,source) end
...
--- @param friendIndex luaindex
--- @return hasCharacter bool,characterName string,zoneName string,classType integer,alliance [Alliance|#Alliance],level integer,championRank integer,zoneId integer
...
--- @return hasOutstandingGuildHistoryRequest bool
function HasOutstandingGuildHistoryRequest() end

--- @param guildId integer
--- @param category [GuildHistoryCategory|#GuildHistoryCategory]
--- @return requested bool
function RequestMoreGuildHistoryCategoryEvents(guildId,category) end
...
--- @return eventType integer,secsSinceEvent integer,param1 variant,param2 variant,param3 variant,param4 variant,param5 variant,param6 variant,eventId integer
...
function IsKeyDown *private* (key) end
...
function GetPlayerCrowns *private* () end

--- @return currentCrownGems integer
function GetPlayerCrownGems *private* () end
...
function GetCollectibleCategoryName(collectibleId) end
...
--- @return void
function PlaceInTradeWindow *protected* (tradeIndex) end

--- @param target string
--- @return void
function PlaceInUnitFrame *protected* (target) end
...
--- @param actionSlotIndex luaindex
--- @return quality integer:nilable
function GetSlotItemQuality(actionSlotIndex) end
...
--- @param actionSlotIndex luaindex
--- @return void
function OnSlotDownAndUp *private* (actionSlotIndex) end

--- @param actionSlotIndex luaindex
--- @return void
function OnSlotDown *private* (actionSlotIndex) end

--- @param actionSlotIndex luaindex
--- @return void
function OnSlotUp *private* (actionSlotIndex) end

--- @param moveIndex [SpecialMove|#SpecialMove]
--- @return void
function OnSpecialMoveKeyPressed *private* (moveIndex) end

--- @param moveIndex [SpecialMove|#SpecialMove]
--- @return void
function OnSpecialMoveKeyDown *private* (moveIndex) end

--- @param moveIndex [SpecialMove|#SpecialMove]
--- @return void
function OnSpecialMoveKeyUp *private* (moveIndex) end
...
--- @param target string
--- @return void
function SendChatMessage *private* (message,channelId,target) end
...
--- @return void
function PlaceInActionBar *protected* (actionSlot) end

--- @param bagId [Bag|#Bag]
--- @param slotIndex integer
--- @return void
function PlaceInInventory *protected* (bagId,slotIndex) end
...
--- @return void
function RequestMoveItem *protected* (sourceBag,sourceSlot,destBag,destSlot,stackCount) end

--- @param slot integer
--- @return void
function PlaceInEquipSlot *protected* (slot) end

--- @param attachmentSlot luaindex
--- @return void
function PlaceInAttachmentSlot *protected* (attachmentSlot) end

--- @param actionSlot luaindex
--- @return void
function PickupAction *protected* (actionSlot) end

--- @param abilityIndex luaindex
--- @return void
function PickupAbility *protected* (abilityIndex) end

--- @param skillType [SkillType|#SkillType]
--- @param skillLineIndex luaindex
--- @param skillIndex luaindex
--- @return void
function PickupAbilityBySkillLine *protected* (skillType,skillLineIndex,skillIndex) end

--- @param bagId [Bag|#Bag]
--- @param slotIndex integer
--- @param count integer
--- @return void
function PickupInventoryItem *protected* (bagId,slotIndex,count) end

--- @param slot integer
--- @return void
function PickupEquippedItem *protected* (slot) end

--- @param tradeIndex luaindex
--- @return void
function PickupTradeItem *protected* (tradeIndex) end

--- @param journalQuestIndex luaindex
--- @param toolIndex luaindex
--- @return void
function PickupQuestTool *protected* (journalQuestIndex,toolIndex) end

--- @param journalQuestIndex luaindex
--- @param stepIndex luaindex
--- @param conditionIndex luaindex
--- @return void
function PickupQuestItem *protected* (journalQuestIndex,stepIndex,conditionIndex) end

--- @param entryIndex luaindex
--- @return void
function PickupStoreItem *protected* (entryIndex) end

--- @param entryIndex luaindex
--- @return void
function PickupStoreBuybackItem *protected* (entryIndex) end

--- @param collectibleId integer
--- @return void
function PickupCollectible *protected* (collectibleId) end

--- @param destroyItem bool
--- @return void
function RespondToDestroyRequest *private* (destroyItem) end

--- @param bag [Bag|#Bag]
--- @param slotIndex integer
--- @return void
function InitiateConfirmUseInventoryItem *protected* (bag,slotIndex) end

--- @param useItem bool
--- @return void
function RespondToConfirmUseInventoryItemRequest *private* (useItem) end
...
--- @param modifier4 [KeyCode|#KeyCode]
--- @return void
function BindKeyToAction *protected* (layerIndex,categoryIndex,actionIndex,bindingIndex,key,modifier1,modifier2,modifier3,modifier4) end
...
--- @param bindingIndex luaindex
--- @return void
function UnbindKeyFromAction *protected* (layerIndex,categoryIndex,actionIndex,bindingIndex) end

--- @param layerIndex luaindex
--- @param categoryIndex luaindex
--- @param actionIndex luaindex
--- @return void
function UnbindAllKeysFromAction *protected* (layerIndex,categoryIndex,actionIndex) end
...
--- @return synergyName string:nilable,iconFilename textureName:nilable
...
--- @return electionType [GroupElectionType|#GroupElectionType],timeRemainingSeconds integer,electionDescriptor string,targetUnitTag string
...
--- @param actionSlotIndex luaindex
--- @return void
function ClearSlot *protected* (actionSlotIndex) end

--- @param abilityIndex luaindex
--- @param actionSlotIndex luaindex
--- @return void
function SelectSlotAbility *protected* (abilityIndex,actionSlotIndex) end

--- @param bagId [Bag|#Bag]
--- @param bagSlotId integer
--- @param actionSlotIndex luaindex
--- @return void
function SelectSlotItem *protected* (bagId,bagSlotId,actionSlotIndex) end

--- @param actionType [ActionBarSlotType|#ActionBarSlotType]
--- @param actionId integer
--- @param actionSlotIndex luaindex
--- @return void
function SelectSlotSimpleAction *protected* (actionType,actionId,actionSlotIndex) end

--- @param actionSlotIndex luaindex
--- @return void
function SelectLastSlottedItem *protected* (actionSlotIndex) end
...
--- @param journalQuestIndex luaindex
--- @param rewardIndex luaindex
--- @return type [RewardType|#RewardType],name string,amount integer,iconFile textureName,meetsUsageRequirement bool,itemQuality [ItemQuality|#ItemQuality],itemType [RewardItemType|#RewardItemType]:nilable
...
--- @param index luaindex
--- @return icon textureName,itemName string,quality integer,stackCount integer,sellerName string,timeRemaining integer,purchasePrice integer,currencyType [CurrencyType|#CurrencyType],itemUniqueId id64,purchasePricePerUnit number
...
--- @param index luaindex
--- @return icon textureName,itemName string,quality integer,stackCount integer,sellerName string,timeRemaining integer,salePrice integer,currencyType [CurrencyType|#CurrencyType],itemUniqueId id64,salePricePerUnit number
...
--- @param index luaindex
--- @return name string,mapType [UIMapType|#UIMapType],mapContentType [MapContentType|#MapContentType],zoneId integer,description string
...
--- @param entryIndex luaindex
--- @return icon textureName,name string,stack integer,price integer,quality [ItemQuality|#ItemQuality],meetsRequirementsToEquip bool
...
--- @param tradeIndex luaindex
--- @return name string,icon textureName,stack integer,quality integer,creatorName string,sellPrice integer,meetsUsageRequirement bool,equipType [EquipType|#EquipType],itemStyleId integer
...
--- @param mailId id64
--- @param attachIndex luaindex
--- @return icon textureName,stack integer,creatorName string,sellPrice integer,meetsUsageRequirement bool,equipType integer,itemStyleId integer,quality integer
...
--- @param achievementId integer
--- @return hasRewardOfType bool,itemName string,iconTextureName string,quality integer
...
function StartSettingChamber *private* (chamberIndex) end
...
--- @param resultIndex luaindex
--- @return translationName string,itemName string,icon textureName,sellPrice integer,meetsUsageRequirement bool,equipType [EquipType|#EquipType],itemStyleId integer,quality [ItemQuality|#ItemQuality]
...
--- @param resultIndex luaindex
--- @return traitName string,itemName string,icon textureName,sellPrice integer,meetsUsageRequirement bool,equipType [EquipType|#EquipType],itemStyleId integer,quality [ItemQuality|#ItemQuality]
...
--- @param resultIndex luaindex
--- @return name string,icon textureName,stack integer,sellPrice integer,meetsUsageRequirement bool,equipType [EquipType|#EquipType],itemType [ItemType|#ItemType],itemStyleId integer,quality [ItemQuality|#ItemQuality],soundCategory [ItemUISoundCategory|#ItemUISoundCategory],itemInstanceId integer
...
--- @param reagent3BagId [Bag|#Bag]:nilable
--- @param reagent3SlotIndex integer:nilable
--- @return name string,icon textureName,stack integer,sellPrice integer,meetsUsageRequirement bool,equipType [EquipType|#EquipType],itemStyleId integer,quality [ItemQuality|#ItemQuality],prospectiveAlchemyResult [ProspectiveAlchemyResult|#ProspectiveAlchemyResult]
...
--- @return known bool,name string,numIngredients integer,provisionerLevelReq integer,qualityReq integer,specialIngredientType [ProvisionerSpecialIngredientType|#ProvisionerSpecialIngredientType],requiredCraftingStationType [TradeskillType|#TradeskillType]
function GetRecipeInfo(recipeListIndex,recipeIndex) end

--- @param recipeListIndex luaindex
--- @param recipeIndex luaindex
--- @param ingredientIndex luaindex
--- @return name string,icon textureName,requiredQuantity integer,sellPrice integer,quality [ItemQuality|#ItemQuality]
...
--- @param aspectRuneBagId [Bag|#Bag]
--- @param aspectRuneSlotIndex integer
--- @return name string,icon textureName,stack integer,sellPrice integer,meetsUsageRequirement bool,quality [ItemQuality|#ItemQuality]
...
--- @param patternIndex luaindex
--- @param materialIndex luaindex
--- @return itemName string,icon textureName,stack integer,sellPrice integer,meetsUsageRequirement bool,equipType [EquipType|#EquipType],itemStyleId integer,quality [ItemQuality|#ItemQuality],itemInstanceId integer,skillRequirement integer,createsItemOfLevel integer,isChampionPoint bool
...
--- @return traitType [ItemTraitType|#ItemTraitType]:nilable,itemName string,icon textureName,sellPrice integer,meetsUsageRequirement bool,itemStyleId integer,quality [ItemQuality|#ItemQuality]
...
--- @return itemName string,icon textureName,currentStack integer,sellPrice integer,meetsUsageRequirement bool,equipType [EquipType|#EquipType],itemStyleId integer,quality [ItemQuality|#ItemQuality]
...
--- @param itemToImproveSlotIndex integer
--- @param craftingSkillType [TradeskillType|#TradeskillType]
--- @return itemName string,icon textureName,sellPrice integer,meetsUsageRequirement bool,equipType [EquipType|#EquipType],itemStyleId integer,quality [ItemQuality|#ItemQuality]
...
--- @param index luaindex
--- @return void
function PlayDefaultQuickChat *private* (index) end
...
--- @return void
function StartWorldParticleEffect *private* (particleEffectId) end

--- @param particleEffectId integer
--- @return void
function StopWorldParticleEffect *private* (particleEffectId) end
...
--- @param worldZ number
--- @return void
function SetWorldParticleEffectPosition *private* (particleEffectId,worldX,worldY,worldZ) end
...
--- @return void
function SetWorldParticleEffectOrientation *private* (particleEffectId,pitchRadians,yawRadians,rollRadians) end

--- @param particleEffectId integer
--- @param scale number
--- @return void
function SetWorldParticleEffectScale *private* (particleEffectId,scale) end

--- @param particleEffectId integer
--- @return void
function DeleteWorldParticleEffect *private* (particleEffectId) end

--- @param UIWorldEffect [UIWorldEffect|#UIWorldEffect]
--- @return void
function StartWorldEffectOnPlayer *private* (UIWorldEffect) end

--- @return emailAddress string
function GetActiveUserEmailAddress *private* () end
...
--- @param axis [AxisTypes|#AxisTypes]
...
--- @param furnitureId id64
--- @return quality [ItemQuality|#ItemQuality]
function GetPlacedHousingFurnitureQuality(furnitureId) end
...
--- @return void
function HousingEditorApplyTemplate(houseTemplateId) end
...
--- @param slotIndex integer
--- @return void
function UseItem *protected* (bagId,slotIndex) end
...
--- @param bagId [Bag|#Bag]
--- @param slotIndex integer
--- @return icon textureName,stack integer,sellPrice integer,meetsUsageRequirement bool,locked bool,equipType [EquipType|#EquipType],itemStyleId integer,quality [ItemQuality|#ItemQuality]
...
--- @param slotIndex integer
--- @return quality [ItemQuality|#ItemQuality]
function GetItemQuality(bagId,slotIndex) end
...
--- @return void
function UpdateMarketDisplayGroup *private* (displayGroup) end

--- @param displayGroup [MarketDisplayGroup|#MarketDisplayGroup]
--- @return numCategories integer
function GetNumMarketProductCategories *private* (displayGroup) end
...
function GetMarketProductCategoryInfo *private* (displayGroup,topLevelIndex) end

--- @param displayGroup [MarketDisplayGroup|#MarketDisplayGroup]
--- @param topLevelIndex luaindex
--- @param subCategoryIndex luaindex
--- @return name string,numMarketProducts integer,showGemIcon bool
function GetMarketProductSubCategoryInfo *private* (displayGroup,topLevelIndex,subCategoryIndex) end
...
function GetMarketProductInfo *private* (marketProductId) end
...
function GetMarketProductPricingByPresentation *private* (marketProductId,presentationIndex) end
...
--- @param marketProductId integer
--- @return icon textureName
function GetMarketProductIcon *private* (marketProductId) end

--- @param marketProductId integer
--- @return instantUnlockId integer
function GetMarketProductInstantUnlockId *private* (marketProductId) end

--- @param marketProductId integer
--- @return instantUnlock [InstantUnlockRewardType|#InstantUnlockRewardType]
function GetMarketProductInstantUnlockType *private* (marketProductId) end
...
function CouldPurchaseMarketProduct *private* (marketProductId,presentationIndex) end

--- @param marketProductId integer
--- @param presentationIndex luaindex:nilable
--- @return expectedGiftResult [MarketPurchasableResult|#MarketPurchasableResult]
function CouldGiftMarketProduct *private* (marketProductId,presentationIndex) end

--- @param marketProductId integer
--- @return isPurchased bool
function IsMarketProductPurchased *private* (marketProductId) end

--- @param marketProductId integer
--- @return passesPurchaseReq bool,errorStringId integer
function DoesMarketProductPassPurchasableReqList *private* (marketProductId) end

--- @param marketProductId integer
--- @return hasDLC bool
function DoesMarketProductContainDLC *private* (marketProductId) end

--- @param marketProductId integer
--- @return errorStringId integer
function GetMarketProductEligibilityErrorStringIds *private* (marketProductId) end

--- @param marketProductId integer
--- @return errorStringId integer
function GetMarketProductCompleteErrorStringId *private* (marketProductId) end

--- @param marketProductId integer
--- @return itemId integer,iconFile textureName,name string,itemQuality [ItemQuality|#ItemQuality],requiredLevel integer,itemCount integer
function GetMarketProductItemInfo *private* (marketProductId) end

--- @param marketProductId integer
--- @param linkStyle [LinkStyle|#LinkStyle]
--- @return link string
function GetMarketProductItemLink *private* (marketProductId,linkStyle) end

--- @param marketProductId integer
--- @return productType [MarketProductType|#MarketProductType]
function GetMarketProductType *private* (marketProductId) end
...
--- @param marketProductId integer
--- @return description string
function GetMarketProductDescription *private* (marketProductId) end

--- @param marketProductId integer
--- @return numChildren integer
function GetMarketProductNumChildren *private* (marketProductId) end

--- @param marketProductId integer
--- @param childIndex luaindex
--- @return childId integer
function GetMarketProductChildId *private* (marketProductId,childIndex) end

--- @param marketProductId integer
--- @return numBundledProducts integer
function GetMarketProductNumBundledProducts *private* (marketProductId) end

--- @param marketProductId integer
--- @return stackCount integer
function GetMarketProductStackCount *private* (marketProductId) end

--- @param marketProductId integer
--- @return furnitureDataId integer
function GetMarketProductFurnitureDataId *private* (marketProductId) end

--- @param marketProductId integer
--- @return itemQuality [ItemQuality|#ItemQuality]
function GetMarketProductQuality *private* (marketProductId) end

--- @param marketProductId integer
--- @return openBehavior [OpenMarketBehavior|#OpenMarketBehavior]
function GetMarketProductOpenMarketBehavior *private* (marketProductId) end

--- @param marketProductId integer
--- @return openToMarketProductId integer
function GetMarketProductOpenMarketBehaviorReferenceData *private* (marketProductId) end

--- @param marketProductId integer
--- @return shouldShowNotice bool
function ShouldMarketProductShowClaimGiftNotice *private* (marketProductId) end

--- @param marketProductId integer
--- @return noticeText string,helpCategoryIndex luaindex:nilable,helpIndex luaindex:nilable
function GetMarketProductClaimGiftNoticeInfo *private* (marketProductId) end
...
--- @param marketProductId integer
--- @return isNew bool
function IsMarketProductNew *private* (marketProductId) end

--- @param marketProductId integer
--- @return isFeatured bool
function IsMarketProductFeatured *private* (marketProductId) end

--- @param marketProductId integer
--- @param presentationIndex luaindex:nilable
--- @return isGiftable bool
function IsMarketProductGiftable *private* (marketProductId,presentationIndex) end

--- @param marketProductId integer
--- @return numCollectibles integer
function GetMarketProductNumCollectibles *private* (marketProductId) end
...
function GetMarketProductCollectibleInfo *private* (marketProductId) end

--- @param marketProductId integer
--- @return collectibleId integer
function GetMarketProductCollectibleId *private* (marketProductId) end

--- @param marketProductId integer
--- @return hidesChildProducts bool
function GetMarketProductBundleHidesChildProducts *private* (marketProductId) end

--- @param marketProductId integer
--- @return crateId integer
function GetMarketProductCrownCrateId *private* (marketProductId) end

--- @param marketProductId integer
--- @return houseId integer
function GetMarketProductHouseId *private* (marketProductId) end

--- @param marketProductId integer
--- @return houseTemplateId integer
function GetMarketProductHouseTemplateId *private* (marketProductId) end

--- @param marketProductId integer
--- @return timeLeftSeconds number
function GetMarketProductLTOTimeLeftInSeconds *private* (marketProductId) end

--- @param marketProductId integer
--- @return timeLeftSeconds number
function GetMarketProductSaleTimeLeftInSeconds *private* (marketProductId) end

--- @param marketProductId integer
--- @return endTimeString string
function GetMarketProductEndTimeString *private* (marketProductId) end
...
--- @param marketProductId integer
--- @return expectedPurchaseResult [MarketPurchasableResult|#MarketPurchasableResult]
function CouldAcquireMarketProduct *private* (marketProductId) end

--- @param marketProductId integer
--- @return openSlotsNeeded integer
function GetSpaceNeededToAcquireMarketProduct *private* (marketProductId) end

--- @param displayGroup [MarketDisplayGroup|#MarketDisplayGroup]
--- @return void
function OpenMarket *private* (displayGroup) end

--- @param displayGroup [MarketDisplayGroup|#MarketDisplayGroup]
--- @return marketState [MarketState|#MarketState]
function GetMarketState *private* (displayGroup) end
...
function CreateCrownCrateSpecificParticleEffect *private* (crownCrateId,crownCrateParticleEffects,worldX,worldY,worldZ) end
...
--- @param worldZ number
--- @return particleEffectId integer:nilable
function CreateCrownCrateTierSpecificParticleEffect *private* (crownCrateTierId,crownCrateTierParticleEffects,worldX,worldY,worldZ) end
...
--- @return void
function SetShowHiddenGearOnActivePreviewRules *private* (showHiddenGear) end

--- @return showHiddenGear bool
function GetShowHiddenGearFromActivePreviewRules *private* () end
...
--- @return void
function AddOutfitSlotPreviewElementToPreviewCollection *private* (previewCollectionId,outfitSlot,collectibleDefId,itemMaterialIndex,primaryDyeDefId,secondaryDyeDefId,accentDyeDefId,refreshIfShowing) end
...
--- @param dyeBrushId integer
--- @return void
function PreviewCollectible *private* (collectibleDefId,variation,dyeBrushId) end

--- @param collectibleDefId integer
--- @param variation luaindex
--- @return void
function PreviewCollectibleAsFurniture *private* (collectibleDefId,variation) end
...
--- @param dyeBrushId integer
--- @return void
function PreviewArmorByItemLink *private* (itemLink,dyeBrushId) end

--- @param recipeListIndex luaindex
--- @param recipeIndex luaindex
--- @param variation luaindex
--- @return void
function PreviewProvisionerItemAsFurniture *private* (recipeListIndex,recipeIndex,variation) end
...
--- @param variation luaindex
--- @return void
function PreviewMarketProduct *private* (marketProductId,variation) end

--- @param marketProductId integer
--- @param variation luaindex
--- @return void
function PreviewFurnitureMarketProduct *private* (marketProductId,variation) end
