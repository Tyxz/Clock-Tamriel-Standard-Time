...
describe("Settings", function()
    ...
    describe("Reset", function()
        ...
        before_each(function()
            require("Lib.Data.Settings")
            local tBoolRef = Clock_TST.settings.booleans
        ...
        it("should reset only the booleans", function()
            ...
            assert.is_not.equal(tBool, Clock_TST.settings.booleans.timeAndMoonAreLinked)
        ...
        it("should reset only the styles", function()
            ...
            assert.is.equal(tBool, Clock_TST.settings.booleans.timeAndMoonAreLinked)
