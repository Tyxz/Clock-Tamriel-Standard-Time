...
describe("Settings", function()
    ...
    insulate("load", function()
        setup(function()
            ...
            stub(Clock_TST, "SetupTime")
            stub(Clock_TST, "SetupMoon")
            require("Lib.Clock")
        end)
        ...
        it("should setup Time", function()
            assert.stub(Clock_TST.SetupTime).was.called_with( match.is_ref(Clock_TST) )
        end)
        it("should setup Moon", function()
            assert.stub(Clock_TST.SetupMoon).was.called_with( match.is_ref(Clock_TST) )
        end)
